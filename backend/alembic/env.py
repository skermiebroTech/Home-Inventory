...
That keeps one source of truth for the HS_ prefixed and bare variable names.
"""
...
async def run_async_migrations() -> None:
    """Open an async engine and run the migrations."""
...
def run_migrations_online() -> None:
    """Run the migrations against the live database."""
